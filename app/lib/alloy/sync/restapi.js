...
function apiCall(_options, _callback) {
    ...
    xhr.onload = function() {
        ...
        try {
            ...
            Ti.API.error('Error parsing response text: ' + String(EE));
    ...
    xhr.onerror = function() {
        ...
        Ti.API.debug("Error Text::" + xhr.responseText);
...
function Sync(method, model, opts) {
    ...
    if ((!opts.data && model) || (method == 'create' || method == 'update')) {
        params.data = opts.data ? opts.data : (method !== 'read' && JSON.stringify(model.toJSON()));
    } else if (opts.data) {
